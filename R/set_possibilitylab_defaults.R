set_possibilitylab_defaults <- function(color_mode = "categorical",
  ...
  ggplot2::update_geom_defaults("point", list(colour = "#1f526f"))
  ggplot2::update_geom_defaults("line", list(colour = "#1f526f"))
  ggplot2::update_geom_defaults("step", list(colour = "#1f526f"))
  ggplot2::update_geom_defaults("path", list(colour = "#1f526f"))
